...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.popit_url'
        db.add_column(u'popit_person', 'popit_url',
                      self.gf('popit.fields.PopItURLField')(default='', max_length=200, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.popit_url'
        db.delete_column(u'popit_person', 'popit_url')
